...
class QTileLayout(QtWidgets.QGridLayout):
    ...
    def changeTilesColor(self, colorChoice, from_tile=(0, 0), to_tile=None):
        ...
        palette = QPalette()
        palette.setColor(QPalette.ColorRole.Shadow, QtGui.QColor(*self.colorMap[colorChoice]))
        palette_idle = QPalette()
        palette_idle.setColor(QPalette.ColorRole.Shadow, QtGui.QColor(*self.colorMap['idle']))
        if to_tile is None:
